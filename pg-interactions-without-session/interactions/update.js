...
export default function (services) {
  ...
  return async function update(args) {
    ...
    const {context} = args;
    let {process, id, name, parentId, fromService, toService, action, innerAction, messageId, state, created, modified, completed, error, cancelled, processAt, processIn, ...options} = args;
