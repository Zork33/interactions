...
CREATE TABLE interaction (
  ...
  -- сессия, в рамках которой выполняется interaction
...
ALTER TABLE interaction ADD CONSTRAINT fk_session FOREIGN KEY (session_id) REFERENCES session(id) DEFERRABLE;

ALTER TABLE interaction ADD CONSTRAINT fk_parent FOREIGN KEY (parent_id) REFERENCES interaction(id) DEFERRABLE;

CREATE INDEX ON interaction (session_id);
